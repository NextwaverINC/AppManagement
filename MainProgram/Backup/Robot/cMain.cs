        ...
        public void DemoProcess_OutputDataReceived(object sender, DataReceivedEventArgs e)
        {
            ...
            if (Output != null)
            {
                ...
                else
                {
                    ...
                    SaveLog("DemoProcess_OutputDataReceived => ผลลัพธ์จากการทำงาน : " + Output);
                    //MessageBox.Show("ผลลัพธ์จากการทำงาน : " + Output, "ทำงานสำเร็จแล้ว", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
        }
        #endregion        
